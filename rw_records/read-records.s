...
.section .text
	...
	#we'll store the input and output descriptors
...
record_read_loop:
	...
	#movl $RECORD_FIRSTNAME, %edx
#	movl $RECOddRD_LASTNAME + record_buffer, %ecx #With $, it changes/mov/etc the memory value not the value pointed by
	int $LINUX_SYSCALL
